...
| [integrations.md](integrations.md) | Fast routing by ecosystem surface: CrewAI, AutoGen, OpenAI Agents SDK, OpenClaw, LangChain/LangGraph, Vercel AI SDK, MCP, TS, HTTP, plus the right install path for each. |
